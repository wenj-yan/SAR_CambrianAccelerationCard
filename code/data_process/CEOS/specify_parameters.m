...
input_path        = 'E:\SAR\数据集\sentinel-1\温哥华经典图像\scene01\';
output_path       = 'E:\SAR\数据集\sentinel-1\温哥华经典图像\output\';
...
Nrg_cells       =  2048 *2    ;     % Suggest 2048 cells
Nrg_lines_blk   =  6*256 *2 ;   % Suggest 1536, it should be larger than the
